...
// @namespace    unrival
// @version      3.0 
// @description  ▶▶▶上次更新：2023.11.18◀◀◀【💻可最小化💻】🆒支持超星视频、文档、答题、自定义正确率、掉线自动登录🤘取消视频文件加载，多开也不占用网速，放心追剧🍊自定义答题正确率，提高学习效率🍆每日功能测试，在发现问题前就解决问题，防清进度，无不良记录
// @author       unrival
// @run-at       document-end
...
(() => {
  //  var token = 'dampmQGPizKmgwAI', //关注微信公众号：一之哥哥，发送 “token” 领取你的token，填写在两个单引号中间并保存，可以提高答题并发数量。
   var token = GM_getValue('tikutoken'),
        ...
        accuracy = 10, //章节测试正确率百分比，在答题正确率在规定之上并且允许自动提交时才会提交答案
                        ...
                        <div>
                            ...
                            <div  style=" margin-top: 10px;">
                                ...
                                <div class="panel-body">
                                    ...
                                    <p>本人是大四学生，看这些网课我也觉得浪费时间，当时因为脚本作者不更新，索性copycopy修改修改自己用，随后一想干脆发布出去，没想到发展到现在都有人用<p/>
                                    <p>当时放个赞赏码在这纯属侥幸，也没想到现在会从哥哥姐姐们手里收到零零碎碎的小费<p/>                     
                                    <p>一开始我就不抱任何希望，然后都是几毛几毛，到现在偶尔有富哥富姐比较豪横<p/>                  
